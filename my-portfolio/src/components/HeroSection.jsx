    ...
    <section className="bg-gray-200 text-black py-16">
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2 md:pl-8">
          <h2 className="text-3xl font-bold mb-4">Nice to meet you! I'm Ann Kiunga.</h2>
          ...
          <p className="mt-6 underline-custom">
            <a href="#contact" className=" hover:text-blue-400 transition-colors font-semibold">CONTACT ME</a>
          </p>
        </div>
      </div>
    </section>
